                                ...
                                <tr>
                                    <td align='center' class='m_30761971433926308nopad' style='font-size:0px;padding:10px 0px;word-break:break-word'>
                                        <div style='font-family:Roboto,Helvetica,sans-serif;font-size:18px;font-weight:600;line-height:1.2;text-align:start ;color:#ffffff'>
                                            ...
                                            <p style='color:#ffffff'>Estimado asociado(a), estos son sus datos de acceso:</p><br>
                                            <b>URL: </b><a href='http://192.168.150.4:8043/page/inscribase/login/?cedula=<?php echo $this->usuario ?>' style=' color:#FFF;'>http://192.168.150.4:8043/page/inscribase/login/</a><br>

                                            <b>Usuario:</b> <?php echo $this->usuario ?><br>
                                            <b>Contraseña:</b> <?php echo $this->clave ?><br>
                                        </div>
                                    </td>
                                </tr>
