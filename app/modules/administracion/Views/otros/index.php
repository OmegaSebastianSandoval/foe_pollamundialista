            ...
            <div class="row">
	                ...
	                <label class="input-group">
	                    ...
	                    <select class="form-control" name="usuario">
	                        ...
	                        <?php foreach ($this->list_usuario as $key => $value) : ?>
	                            <option value="<?= $key; ?>" <?php if ($this->getObjectVariable($this->filters, 'usuario') ==  $key) { echo "selected";} ?>><?= $value; ?></option>
	                        <?php endforeach ?>
	                    </select>
	               </label>
	            </div>
				<div class="col-3">
	                ...
	                <label class="input-group">
	                    ...
	                    <select class="form-control" name="goleador">
	                        <option value="">Todas</option>
	                        <?php foreach ($this->list_goleador as $key => $value) : ?>
	                            <option value="<?= $key; ?>" <?php if ($this->getObjectVariable($this->filters, 'goleador') ==  $key) { echo "selected";} ?>><?= $value; ?></option>
	                        <?php endforeach ?>
	                    </select>
	               </label>
	            </div>
				<div class="col-3">
	                ...
	                <label class="input-group">
	                    ...
	                    <select class="form-control" name="valla">
	                        <option value="">Todas</option>
	                        <?php foreach ($this->list_valla as $key => $value) : ?>
	                            <option value="<?= $key; ?>" <?php if ($this->getObjectVariable($this->filters, 'valla') ==  $key) { echo "selected";} ?>><?= $value; ?></option>
	                        <?php endforeach ?>
	                    </select>
	               </label>
	            </div>
	...
	<div class="content-dashboard">
		...
		<table class=" table table-striped  table-hover table-administrator text-left">
			...
			<tbody>
				...
				<?php $id =  $content->id; ?>
					<tr>
						<td><?= $this->list_usuario[$content->usuario];?>
						<td><?= $this->list_goleador[$content->goleador];?>
						<td><?= $this->list_valla[$content->valla];?>
						<td class="text-right">
							<div>
