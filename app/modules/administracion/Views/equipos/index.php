        ...
        <div class="content-dashboard">
            <div class="row">
				...
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="bandera" value="<?php echo $this->getObjectVariable($this->filters, 'bandera') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
					<label>grupo</label>
	                <label class="input-group">
	                    ...
	                    <select class="form-control" name="grupo">
	                        ...
	                        <?php foreach ($this->list_grupo as $key => $value) : ?>
	                            <option value="<?= $key; ?>" <?php if ($this->getObjectVariable($this->filters, 'grupo') ==  $key) { echo "selected";} ?>><?= $value; ?></option>
	                        <?php endforeach ?>
	                    </select>
	               </label>
	            </div>
			...
			<tbody>
				...
				<?php $id =  $content->id; ?>
					<tr>
						...
						<td>
							<?php if($content->bandera) { ?>
								<img src="/images/<?= $content->bandera; ?>"  class="img-thumbnail thumbnail-administrator" />
							<?php } ?>
							<div><?= $content->bandera; ?></div>
						</td>
						<td><?= $this->list_grupo[$content->grupo];?>
						<td>
