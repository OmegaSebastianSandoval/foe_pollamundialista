        ...
        <div class="content-dashboard">
            <div class="row">
				...
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="campeon" value="<?php echo $this->getObjectVariable($this->filters, 'campeon') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="subcampeon" value="<?php echo $this->getObjectVariable($this->filters, 'subcampeon') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            <label>tercero</label>
		            ...
		            <input type="text" class="form-control" name="tercero" value="<?php echo $this->getObjectVariable($this->filters, 'tercero') ?>"></input>
		            </label>
		        </div>
                <div class="col-3">
                    <label>&nbsp;</label>
			...
			<tbody>
				...
				<?php $id =  $content->id; ?>
					<tr>
						...
						<td><?=$content->campeon;?></td>
						<td><?=$content->subcampeon;?></td>
						<td><?=$content->tercero;?></td>
						<td class="text-right">
							<div>
