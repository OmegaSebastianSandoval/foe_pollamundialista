        ...
        <div class="content-dashboard">
            <div class="row">
				...
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="e1" value="<?php echo $this->getObjectVariable($this->filters, 'e1') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            <label>e2</label>
		            ...
		            <input type="text" class="form-control" name="e2" value="<?php echo $this->getObjectVariable($this->filters, 'e2') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            <label>e3</label>
		            ...
		            <input type="text" class="form-control" name="e3" value="<?php echo $this->getObjectVariable($this->filters, 'e3') ?>"></input>
		            </label>
		        </div>
                <div class="col-3">
                    <label>&nbsp;</label>
