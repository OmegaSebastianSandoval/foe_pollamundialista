...
<div class="container-fluid">
	<form action="<?php echo $this->route; ?>" method="post" class="d-none">
        <div class="content-dashboard ">
            <div class="row">
				<div class="col-3">
					<label>clasificado octavos a1</label>
	                <label class="input-group">
	                    ...
	                    <select class="form-control" name="clasificado_octavos_a1">
	                        ...
	                        <?php foreach ($this->list_clasificado_octavos_a1 as $key => $value) : ?>
	                            <option value="<?= $key; ?>" <?php if ($this->getObjectVariable($this->filters, 'clasificado_octavos_a1') ==  $key) { echo "selected";} ?>><?= $value; ?></option>
	                        <?php endforeach ?>
	                    </select>
	               </label>
	            </div>
				<div class="col-3">
					<label>clasificado octavos a2</label>
	                <label class="input-group">
						<div class="input-group-prepend">
	                    ...
	                    <select class="form-control" name="clasificado_octavos_a2">
	                        ...
	                        <?php foreach ($this->list_clasificado_octavos_a2 as $key => $value) : ?>
	                            <option value="<?= $key; ?>" <?php if ($this->getObjectVariable($this->filters, 'clasificado_octavos_a2') ==  $key) { echo "selected";} ?>><?= $value; ?></option>
	                        <?php endforeach ?>
	                    </select>
	               </label>
	            </div>
				<div class="col-3">
					<label>clasificado octavos b1</label>
	                <label class="input-group">
						<div class="input-group-prepend">
	                    ...
	                    <select class="form-control" name="clasificado_octavos_b1">
	                        ...
	                        <?php foreach ($this->list_clasificado_octavos_b1 as $key => $value) : ?>
	                            <option value="<?= $key; ?>" <?php if ($this->getObjectVariable($this->filters, 'clasificado_octavos_b1') ==  $key) { echo "selected";} ?>><?= $value; ?></option>
	                        <?php endforeach ?>
	                    </select>
	               </label>
	            </div>
	...
	<div class="content-dashboard">
		...
		<table class=" table table-striped  table-hover table-administrator text-left">
			...
			<tbody>
				...
				<?php $id =  $content->clasificado_id; ?>
					<tr>
						<td><?= $this->list_clasificado_cuartos_e1[$content->clasificado_cuartos_e1];?>
						<td><?= $this->list_clasificado_cuartos_e2[$content->clasificado_cuartos_e2];?>
						<td><?= $this->list_clasificado_cuartos_e3[$content->clasificado_cuartos_e3];?>
						<td><?= $this->list_clasificado_cuartos_e4[$content->clasificado_cuartos_e4];?>
						<td><?= $this->list_clasificado_cuartos_e5[$content->clasificado_cuartos_e5];?>
						<td><?= $this->list_clasificado_cuartos_e6[$content->clasificado_cuartos_e6];?>
						<td><?= $this->list_clasificado_cuartos_e7[$content->clasificado_cuartos_e7];?>
						<td><?= $this->list_clasificado_cuartos_e8[$content->clasificado_cuartos_e8];?>
						<td class="text-right">
							<div>
