        ...
        <div class="content-dashboard">
            <div class="row">
				...
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="a1" value="<?php echo $this->getObjectVariable($this->filters, 'a1') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            <label>a2</label>
		            ...
		            <input type="text" class="form-control" name="a2" value="<?php echo $this->getObjectVariable($this->filters, 'a2') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            <label>b1</label>
		            ...
		            <input type="text" class="form-control" name="b1" value="<?php echo $this->getObjectVariable($this->filters, 'b1') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            <label>b2</label>
		            ...
		            <input type="text" class="form-control" name="b2" value="<?php echo $this->getObjectVariable($this->filters, 'b2') ?>"></input>
		            </label>
		        </div>
                <div class="col-3">
                    <label>&nbsp;</label>
