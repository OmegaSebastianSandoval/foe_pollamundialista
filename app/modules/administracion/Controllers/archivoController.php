<?php
/**
* Controlador de Archivo que permite la  creacion, edicion  y eliminacion de los archivo del Sistema
*/
class Administracion_archivoController extends Administracion_mainController
{
	 ...
	 * @var string
	 */
	protected $_csrf_section = "administracion_archivo";
	...
	/**
     * Inicializa las variables principales del controlador archivo .
     *
     * @return void.
     */
	public function init()
	{
		$this->mainModel = new Administracion_Model_DbTable_Archivo();
		$this->namefilter = "parametersfilterarchivo";
		$this->route = "/administracion/archivo";
		$this->namepages ="pages_archivo";
		$this->namepageactual ="page_actual_archivo";
	...
	{
		$title = "Administración de archivo";
	...
	{
		$this->_view->route = $this->route;
		$this->_csrf_section = "manage_archivo_".date("YmdHis");
	...
	public function updateAction(){
		...
		//header('Location: '.$this->route.''.'');
				...
				header('Location: /administracion/archivo/carga/');
	}
	...
	public function cargaAction()
	{
		...
		//$this->getLayout()->setTitle("Importar partidos");
...
print_r($fila);
		...
		header("Location:/administracion/cedulas/");
	...
	/**
     * Recibe la informacion del formulario y la retorna en forma de array para la edicion y creacion de Archivo.
     *
    ...
    protected function filters()
    {
        if ($this->getRequest()->isPost()== true) {
            ...
            $parramsfilter = array();
					$parramsfilter['archivo_cedulas'] =  $this->_getSanitizedParam("archivo_cedulas");Session::getInstance()->set($this->namefilter, $parramsfilter);
        }
