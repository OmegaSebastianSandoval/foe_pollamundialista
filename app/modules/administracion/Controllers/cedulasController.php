<?php
/**
* Controlador de Cedulas que permite la  creacion, edicion  y eliminacion de los cedula del Sistema
*/
class Administracion_cedulasController extends Administracion_mainController
{
	...
	/**
	 * $mainModel  instancia del modelo de  base de datos cedula
	...
	/**
     * Recibe la informacion y  muestra un listado de  cedula con sus respectivos filtros.
     *
     * @return void.
     */
	public function indexAction()
	{
		$title = "Administración de cedula";
	...
	/**
     * Inserta la informacion de un cedula  y redirecciona al listado de cedula.
     *
     * @return void.
     */
	...
	/**
     * Recibe un identificador  y Actualiza la informacion de un cedula  y redirecciona al listado de cedula.
     *
     * @return void.
     */
	...
	/**
     * Recibe un identificador  y elimina un cedula  y redirecciona al listado de cedula.
     *
     * @return void.
     */
